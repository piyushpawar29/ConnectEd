  ...
  return (
    <div className="h-[calc(100vh-4rem)] p-4">
      ...
      <div className="flex items-center justify-between mb-4">  
        ...
        <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white" onClick={() => router.push('/mentee/dashboard')}>Back</Button>
      </div>
